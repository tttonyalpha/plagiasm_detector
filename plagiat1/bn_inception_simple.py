...
class BNInception(nn.Module):
    ...
    def __init__(self, embedding_size, pretrained=True, is_norm=True):
        ...
        self.inception_3b_1x1_bn = nn.BatchNorm2d(
            64, eps=1e-05, momentum=0.9, affine=True)  # snzJiZSB
...
# xO
 ...
 # KvmDWe
        ...
        self.inception_4d_double_3x3_2 = nn.Conv2d(192, 192, kernel_size=(
            3, 3), stride=(1, 1), padding=(1, 1))  # uVbNJPDcLzeZGmT
   ...
   # LMJldkxbEWSQRD
        ...
        inception_3a_double__3x3_1_out = self.inception_3a_double_3x3_1(
            inception_3a_double_3x3_reduce_bn_out)

        inception_3a_double_3x3_1_bn_out = self.inception_3a_double_3x3_1_bn(
            inception_3a_double__3x3_1_out)
        ...
        inception_3a_output_out = torch.cat(
            [incel, inception_3a_3x3_bn_out, inception_3a_double_3x3_2_bn_out, inception_3a_pool_proj_bn_out], 1)
        ...
        inception_3b_relu_double_3x3_reduce_outF = self.inception_3b_relu_double_3x3_reduce(
        ...
        inception = torch.cat([inception_3b_1x1_bn_out, inception_3b_3x3_bn_,
                               inception_3b_double_3x3_2_bn_out, inception_3b_pool_proj_bn_out], 1)
        ...
        inception_3c_double_3x3_2_bn_out = self.inception_3c_double_3x3_2_bn(
            inception_3c_double_3x3_2_out)  # VYeFN
        ...
        inception_4a_relu_1x1_o_ut = self.inception_4a_relu_1x1(
        ...
        inception_4a_3x3_out = self.inception_4a_3x3(
            inception_4a_3x3_reduce_bn_out)  # nYiLZqFWxbmhyDUVKX
        ...
        inception_4a_double_3x3_reduce_out = self.inception_4a_double_3x3_reduce(
            inception_3c_output_out)
        inception__4a_double_3x3_reduce_bn_out = self.inception_4a_double_3x3_reduce_bn(
            inception_4a_double_3x3_reduce_out)
        inception_4a_relu_double_3x3_reduce_out = self.inception_4a_relu_double_3x3_reduce(
            inception__4a_double_3x3_reduce_bn_out)
        ...
        inception_4a_doub = self.inception_4a_double_3x3_2(
            inception_4a_double_3x3_1_bn_out)
        ...
        inception_4b_double_3x3_1_outhwMM = self.inception_4b_double_3x3_1(
            inception_4b_double_3x3_reduce_bn_out)
        inception_4b_double_3x3_1_bn_out = self.inception_4b_double_3x3_1_bn(
            inception_4b_double_3x3_1_outhwMM)
        ...
        inception_4b_output_out = torch.cat(
            [inception_4b_1x1_bn_, inception_4b_3x3_bn_out, inception_4b_double_3x3_2_bn_out, inception_4b_pool_proj_bn_out], 1)
        ...
        inception_4c_relu_3 = self.inception_4c_relu_3x3_reduce(
     ...
     # z
        ...
        inception_4d_relu_dou = self.inception_4d_relu_double_3x3_1(
        ...
        inception_4e_3_x3_reduce_bn_out = self.inception_4e_3x3_reduce_bn(
            inception_4e_3x3_reduce_out)
        inception_4e_relu_3x3_reduce_out = self.inception_4e_relu_3x3_reduce(
            inception_4e_3_x3_reduce_bn_out)
   ...
   # iKCvuTRGMY
        ...
        inception_4e_re = self.inception_4e_relu_double_3x3_2(
        ...
        inception_5a_double_3x3_redu_ce_out = self.inception_5a_double_3x3_reduce(
            inception_4e_output_out)
        inception_5a_double_3x3_reduce_bn_out = self.inception_5a_double_3x3_reduce_bn(
            inception_5a_double_3x3_redu_ce_out)
   # pIzdLGU
        ...
        inception_5b_double_3x3_reduce_outuJ = self.inception_5b_double_3x3_reduce(
            inception_5a_output_out)
        inception_5b_double_3x3_reduce_bn_out = self.inception_5b_double_3x3_reduce_bn(
            inception_5b_double_3x3_reduce_outuJ)
        inception_5b_relu_double_3_x3_reduce_out = self.inception_5b_relu_double_3x3_reduce(
        ...
        inception_5b_double_3x3 = self.inception_5b_double_3x3_2(
            inception_5b_double_3x3_1_bn_out)
        inception_5b_double_3x3_2_bn_out = self.inception_5b_double_3x3_2_bn(
            inception_5b_double_3x3)
